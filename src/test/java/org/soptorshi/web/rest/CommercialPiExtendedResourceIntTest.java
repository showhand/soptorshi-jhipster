...
public class CommercialPiExtendedResourceIntTest {
    ...
    public void createCommercialPi() throws Exception {
        ...
        assertThat(testCommercialPi.getCompanyDescriptionOrAddress()).isEqualTo(DEFAULT_COMPANY_DESCRIPTION_OR_ADDRESS);
    ...
    public void updateCommercialPi() throws Exception {
        ...
        assertThat(testCommercialPi.getCompanyDescriptionOrAddress()).isEqualTo(UPDATED_COMPANY_DESCRIPTION_OR_ADDRESS);
