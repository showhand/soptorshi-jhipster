...
public class CommercialBudgetResourceIntTest {
    ...
    public void createCommercialBudget() throws Exception {
        ...
        assertThat(testCommercialBudget.getOfferedPrice()).isEqualTo(DEFAULT_OFFERED_PRICE);
        assertThat(testCommercialBudget.getBuyingPrice()).isEqualTo(DEFAULT_BUYING_PRICE);
    ...
    public void updateCommercialBudget() throws Exception {
        ...
        assertThat(testCommercialBudget.getOfferedPrice()).isEqualTo(UPDATED_OFFERED_PRICE);
        assertThat(testCommercialBudget.getBuyingPrice()).isEqualTo(UPDATED_BUYING_PRICE);
