...
public class CommercialPoResourceIntTest {
    ...
    public static CommercialPo createEntity(EntityManager em) {
        CommercialPo commercialPo = new CommercialPo()
            ...
            .procurementId(DEFAULT_PROCUREMENT_ID)
    ...
    public void createCommercialPo() throws Exception {
        ...
        assertThat(testCommercialPo.getProcurementId()).isEqualTo(DEFAULT_PROCUREMENT_ID);
        assertThat(testCommercialPo.getInventoryId()).isEqualTo(DEFAULT_INVENTORY_ID);
    ...
    public void updateCommercialPo() throws Exception {
        ...
        updatedCommercialPo
            ...
            .procurementId(UPDATED_PROCUREMENT_ID)
        ...
        assertThat(testCommercialPo.getProcurementId()).isEqualTo(UPDATED_PROCUREMENT_ID);
        assertThat(testCommercialPo.getInventoryId()).isEqualTo(UPDATED_INVENTORY_ID);
