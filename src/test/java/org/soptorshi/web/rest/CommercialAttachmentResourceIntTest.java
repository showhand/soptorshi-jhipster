...
public class CommercialAttachmentResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllCommercialAttachmentsByCommercialPurchaseOrderIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        em.flush();
        commercialAttachment.setCommercialPurchaseOrder(commercialPurchaseOrder);
        commercialAttachmentRepository.saveAndFlush(commercialAttachment);
        Long commercialPurchaseOrderId = commercialPurchaseOrder.getId();

        // Get all the commercialAttachmentList where commercialPurchaseOrder equals to commercialPurchaseOrderId
        defaultCommercialAttachmentShouldBeFound("commercialPurchaseOrderId.equals=" + commercialPurchaseOrderId);

        // Get all the commercialAttachmentList where commercialPurchaseOrder equals to commercialPurchaseOrderId + 1
        defaultCommercialAttachmentShouldNotBeFound("commercialPurchaseOrderId.equals=" + (commercialPurchaseOrderId + 1));
    }


    @Test
    @Transactional
    public void getAllCommercialAttachmentsByCommercialPoStatusIsEqualToSomething() throws Exception {
        // Initialize the database
        CommercialPoStatus commercialPoStatus = CommercialPoStatusResourceIntTest.createEntity(em);
        em.persist(commercialPoStatus);
        em.flush();
        commercialAttachment.setCommercialPoStatus(commercialPoStatus);
        commercialAttachmentRepository.saveAndFlush(commercialAttachment);
        Long commercialPoStatusId = commercialPoStatus.getId();

        // Get all the commercialAttachmentList where commercialPoStatus equals to commercialPoStatusId
        defaultCommercialAttachmentShouldBeFound("commercialPoStatusId.equals=" + commercialPoStatusId);

        // Get all the commercialAttachmentList where commercialPoStatus equals to commercialPoStatusId + 1
        defaultCommercialAttachmentShouldNotBeFound("commercialPoStatusId.equals=" + (commercialPoStatusId + 1));
    }
