...
public class CommercialAttachmentResourceIntTest {
    ...
    public static CommercialAttachment createEntity(EntityManager em) {
        ...
        em.flush();
        commercialAttachment.setCommercialPi(commercialPi);
    ...
    @Test
    @Transactional
    public void getAllCommercialAttachmentsByCommercialPiIsEqualToSomething() throws Exception {
        // Initialize the database
        CommercialPi commercialPi = CommercialPiResourceIntTest.createEntity(em);
        em.persist(commercialPi);
        em.flush();
        ...
        // Get all the commercialAttachmentList where commercialPi equals to commercialPiId
        defaultCommercialAttachmentShouldBeFound("commercialPiId.equals=" + commercialPiId);

        // Get all the commercialAttachmentList where commercialPi equals to commercialPiId + 1
        defaultCommercialAttachmentShouldNotBeFound("commercialPiId.equals=" + (commercialPiId + 1));
    }
