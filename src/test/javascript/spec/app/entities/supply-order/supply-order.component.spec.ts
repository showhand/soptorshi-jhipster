...
import { SupplyOrderComponent } from 'app/entities/supply-order/supply-order.component';
...
describe('Component Tests', () => {
    describe('SupplyOrder Management Component', () => {
        let comp: SupplyOrderComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SupplyOrderComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.supplyOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
