...
import { ExperienceInformationComponent } from 'app/entities/experience-information/experience-information.component';
...
describe('Component Tests', () => {
    describe('ExperienceInformation Management Component', () => {
        let comp: ExperienceInformationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ExperienceInformationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new ExperienceInformation(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.experienceInformations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
