...
import { AcademicInformationComponent } from 'app/entities/academic-information/academic-information.component';
...
describe('Component Tests', () => {
    describe('AcademicInformation Management Component', () => {
        let comp: AcademicInformationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AcademicInformationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new AcademicInformation(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.academicInformations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
