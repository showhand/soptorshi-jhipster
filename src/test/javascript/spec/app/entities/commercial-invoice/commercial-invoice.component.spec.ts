...
import { CommercialInvoiceComponent } from 'app/entities/commercial-invoice/commercial-invoice.component';
...
describe('Component Tests', () => {
    describe('CommercialInvoice Management Component', () => {
        let comp: CommercialInvoiceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CommercialInvoiceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new CommercialInvoice(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.commercialInvoices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
