...
import { CommercialProductInfo, ICommercialProductInfo, UnitOfMeasurements } from 'app/shared/model/commercial-product-info.model';
        ...
        describe('Service methods', async () => {
            ...
            it('should update a CommercialProductInfo', async () => {
                const returnedFromService = Object.assign(
                    {
                        serialNo: 1,
                        packagingDescription: 'BBBBBB',
                        othersDescription: 'BBBBBB',
                        offeredQuantity: 1,
                        offeredUnit: 'BBBBBB',
                        offeredUnitPrice: 1,
                        offeredTotalPrice: 1,
