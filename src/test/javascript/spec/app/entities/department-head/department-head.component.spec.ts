...
import { DepartmentHeadComponent } from 'app/entities/department-head/department-head.component';
...
describe('Component Tests', () => {
    describe('DepartmentHead Management Component', () => {
        let comp: DepartmentHeadComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DepartmentHeadComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.departmentHeads[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
