...
import { ItemSubCategoryComponent } from 'app/entities/item-sub-category/item-sub-category.component';
...
describe('Component Tests', () => {
    describe('ItemSubCategory Management Component', () => {
        let comp: ItemSubCategoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ItemSubCategoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.itemSubCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
