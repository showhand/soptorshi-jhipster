...
describe('Service Tests', () => {
    describe('FinancialAccountYear Service', () => {
        ...
        let elemDefault: IFinancialAccountYear;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FinancialAccountYearService);
        ...
        describe('Service methods', async () => {
            ...
            it('should create a FinancialAccountYear', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        startDate: currentDate.format(DATE_FORMAT),
                ...
                service
                    .create(new FinancialAccountYear(null))
                    .pipe(take(1))
            ...
            it('should update a FinancialAccountYear', async () => {
                const returnedFromService = Object.assign(
                    {
                        startDate: currentDate.format(DATE_FORMAT),
                        endDate: currentDate.format(DATE_FORMAT),
            ...
            it('should return a list of FinancialAccountYear', async () => {
                const returnedFromService = Object.assign(
                    {
                        startDate: currentDate.format(DATE_FORMAT),
                        endDate: currentDate.format(DATE_FORMAT),
            ...
            it('should delete a FinancialAccountYear', async () => {
