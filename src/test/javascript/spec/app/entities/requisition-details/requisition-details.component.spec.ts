...
import { RequisitionDetailsComponent } from 'app/entities/requisition-details/requisition-details.component';
...
describe('Component Tests', () => {
    describe('RequisitionDetails Management Component', () => {
        let comp: RequisitionDetailsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RequisitionDetailsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new RequisitionDetails(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.requisitionDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
