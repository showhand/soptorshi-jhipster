...
import { BudgetAllocationComponent } from 'app/entities/budget-allocation/budget-allocation.component';
...
describe('Component Tests', () => {
    describe('BudgetAllocation Management Component', () => {
        let comp: BudgetAllocationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BudgetAllocationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.budgetAllocations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
