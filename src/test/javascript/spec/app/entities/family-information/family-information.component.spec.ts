...
import { FamilyInformationComponent } from 'app/entities/family-information/family-information.component';
...
describe('Component Tests', () => {
    describe('FamilyInformation Management Component', () => {
        let comp: FamilyInformationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FamilyInformationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new FamilyInformation(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.familyInformations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
