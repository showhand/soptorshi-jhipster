...
import { TrainingInformationComponent } from 'app/entities/training-information/training-information.component';
...
describe('Component Tests', () => {
    describe('TrainingInformation Management Component', () => {
        let comp: TrainingInformationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TrainingInformationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new TrainingInformation(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.trainingInformations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
