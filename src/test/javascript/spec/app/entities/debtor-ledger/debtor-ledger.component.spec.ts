...
import { DebtorLedgerComponent } from 'app/entities/debtor-ledger/debtor-ledger.component';
...
describe('Component Tests', () => {
    describe('DebtorLedger Management Component', () => {
        let comp: DebtorLedgerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DebtorLedgerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.debtorLedgers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
