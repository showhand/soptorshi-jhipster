...
import { ReceiptVoucherComponent } from 'app/entities/receipt-voucher/receipt-voucher.component';
...
describe('Component Tests', () => {
    describe('ReceiptVoucher Management Component', () => {
        let comp: ReceiptVoucherComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ReceiptVoucherComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.receiptVouchers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
