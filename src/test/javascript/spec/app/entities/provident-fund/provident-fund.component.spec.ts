...
import { ProvidentFundComponent } from 'app/entities/provident-fund/provident-fund.component';
...
describe('Component Tests', () => {
    describe('ProvidentFund Management Component', () => {
        let comp: ProvidentFundComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProvidentFundComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.providentFunds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
