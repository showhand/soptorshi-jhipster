...
import { PeriodCloseComponent } from 'app/entities/period-close/period-close.component';
...
describe('Component Tests', () => {
    describe('PeriodClose Management Component', () => {
        let comp: PeriodCloseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PeriodCloseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.periodCloses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
