...
import { JournalVoucherComponent } from 'app/entities/journal-voucher/journal-voucher.component';
...
describe('Component Tests', () => {
    describe('JournalVoucher Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.journalVouchers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
