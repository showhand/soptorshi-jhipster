...
import { InventoryLocationComponent } from 'app/entities/inventory-location/inventory-location.component';
...
describe('Component Tests', () => {
    describe('InventoryLocation Management Component', () => {
        let comp: InventoryLocationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(InventoryLocationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new InventoryLocation(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.inventoryLocations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
