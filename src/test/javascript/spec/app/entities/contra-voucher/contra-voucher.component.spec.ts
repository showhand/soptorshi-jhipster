...
import { ContraVoucherComponent } from 'app/entities/contra-voucher/contra-voucher.component';
...
describe('Component Tests', () => {
    describe('ContraVoucher Management Component', () => {
        let comp: ContraVoucherComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ContraVoucherComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.contraVouchers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
