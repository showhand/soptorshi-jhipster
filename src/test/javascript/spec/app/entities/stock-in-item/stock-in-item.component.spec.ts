...
describe('Component Tests', () => {
    describe('StockInItem Management Component', () => {
        let comp: StockInItemComponent;
        let fixture: ComponentFixture<StockInItemComponent>;
        let service: StockInItemService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [SoptorshiTestModule],
                declarations: [StockInItemComponent],
                providers: [
                    {
                ...
                .overrideTemplate(StockInItemComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(StockInItemComponent);
