...
import { PaymentVoucherComponent } from 'app/entities/payment-voucher/payment-voucher.component';
...
describe('Component Tests', () => {
    describe('PaymentVoucher Management Component', () => {
        let comp: PaymentVoucherComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PaymentVoucherComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.paymentVouchers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
