...
import { ReferenceInformationComponent } from 'app/entities/reference-information/reference-information.component';
...
describe('Component Tests', () => {
    describe('ReferenceInformation Management Component', () => {
        let comp: ReferenceInformationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ReferenceInformationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new ReferenceInformation(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.referenceInformations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
