...
import { ChequeRegisterComponent } from 'app/entities/cheque-register/cheque-register.component';
...
describe('Component Tests', () => {
    describe('ChequeRegister Management Component', () => {
        let comp: ChequeRegisterComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ChequeRegisterComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.chequeRegisters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
