...
import { TermsAndConditionsComponent } from 'app/entities/terms-and-conditions/terms-and-conditions.component';
...
describe('Component Tests', () => {
    describe('TermsAndConditions Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TermsAndConditionsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new TermsAndConditions(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.termsAndConditions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
