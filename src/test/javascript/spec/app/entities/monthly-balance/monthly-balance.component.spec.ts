...
import { MonthlyBalanceComponent } from 'app/entities/monthly-balance/monthly-balance.component';
...
describe('Component Tests', () => {
    describe('MonthlyBalance Management Component', () => {
        let comp: MonthlyBalanceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MonthlyBalanceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.monthlyBalances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
