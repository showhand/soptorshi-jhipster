...
public class CommercialAttachment implements Serializable {
    ...
    public CommercialAttachment commercialPurchaseOrder(CommercialPurchaseOrder commercialPurchaseOrder) {
    ...
    public CommercialPoStatus getCommercialPoStatus() {
        return commercialPoStatus;
    }

    public CommercialAttachment commercialPoStatus(CommercialPoStatus commercialPoStatus) {
        this.commercialPoStatus = commercialPoStatus;
        return this;
    }

    public void setCommercialPoStatus(CommercialPoStatus commercialPoStatus) {
        this.commercialPoStatus = commercialPoStatus;
    }
