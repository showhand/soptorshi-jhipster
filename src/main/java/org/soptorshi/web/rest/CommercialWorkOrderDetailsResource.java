...
@RestController
@RequestMapping("/api")
public class CommercialWorkOrderDetailsResource {

    private final Logger log = LoggerFactory.getLogger(CommercialWorkOrderDetailsResource.class);
    ...
    public CommercialWorkOrderDetailsResource(CommercialWorkOrderDetailsService commercialWorkOrderDetailsService, CommercialWorkOrderDetailsQueryService commercialWorkOrderDetailsQueryService) {
