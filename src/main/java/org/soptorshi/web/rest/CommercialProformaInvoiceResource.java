...
@RestController
@RequestMapping("/api")
public class CommercialProformaInvoiceResource {

    private final Logger log = LoggerFactory.getLogger(CommercialProformaInvoiceResource.class);
    ...
    public CommercialProformaInvoiceResource(CommercialProformaInvoiceService commercialProformaInvoiceService, CommercialProformaInvoiceQueryService commercialProformaInvoiceQueryService) {
