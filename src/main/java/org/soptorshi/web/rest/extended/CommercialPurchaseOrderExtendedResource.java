...
public class CommercialPurchaseOrderExtendedResource extends CommercialPurchaseOrderResource {

    private final Logger log = LoggerFactory.getLogger(CommercialPurchaseOrderExtendedResource.class);
