...
public class CommercialPoStatusExtendedResource extends CommercialPoStatusResource {

    private final Logger log = LoggerFactory.getLogger(CommercialPoStatusExtendedResource.class);
