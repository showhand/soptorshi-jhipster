...
public class CommercialPackagingExtendedResource extends CommercialPackagingResource {

    private final Logger log = LoggerFactory.getLogger(CommercialPackagingExtendedResource.class);
