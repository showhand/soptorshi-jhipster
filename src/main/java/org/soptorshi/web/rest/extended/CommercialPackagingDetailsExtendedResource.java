...
public class CommercialPackagingDetailsExtendedResource extends CommercialPackagingDetailsResource {

    private final Logger log = LoggerFactory.getLogger(CommercialPackagingDetailsExtendedResource.class);
