...
public class CommercialInvoiceExtendedResource extends CommercialInvoiceResource {

    private final Logger log = LoggerFactory.getLogger(CommercialInvoiceExtendedResource.class);
