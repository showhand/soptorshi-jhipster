...
@RestController
@RequestMapping("/api")
public class CommercialPurchaseOrderItemResource {

    private final Logger log = LoggerFactory.getLogger(CommercialPurchaseOrderItemResource.class);

    private static final String ENTITY_NAME = "commercialPurchaseOrderItem";

    private final CommercialPurchaseOrderItemService commercialPurchaseOrderItemService;

    private final CommercialPurchaseOrderItemQueryService commercialPurchaseOrderItemQueryService;

    public CommercialPurchaseOrderItemResource(CommercialPurchaseOrderItemService commercialPurchaseOrderItemService, CommercialPurchaseOrderItemQueryService commercialPurchaseOrderItemQueryService) {
