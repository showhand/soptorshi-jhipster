...
@Service
@Transactional
public class CommercialPoStatusExtendedService extends CommercialPoStatusService {

    private final Logger log = LoggerFactory.getLogger(CommercialPoStatusExtendedService.class);
    ...
    public CommercialPoStatusExtendedService(CommercialPoStatusRepository commercialPoStatusRepository, CommercialPoStatusMapper commercialPoStatusMapper, CommercialPoStatusSearchRepository commercialPoStatusSearchRepository) {
        super(commercialPoStatusRepository, commercialPoStatusMapper, commercialPoStatusSearchRepository);
