...
@Service
@Transactional
public class CommercialPurchaseOrderExtendedService extends CommercialPurchaseOrderService {

    private final Logger log = LoggerFactory.getLogger(CommercialPurchaseOrderExtendedService.class);
