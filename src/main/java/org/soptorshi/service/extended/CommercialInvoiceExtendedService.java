...
@Service
@Transactional
public class CommercialInvoiceExtendedService extends CommercialInvoiceService {

    private final Logger log = LoggerFactory.getLogger(CommercialInvoiceExtendedService.class);
    ...
    public CommercialInvoiceExtendedService(CommercialInvoiceRepository commercialInvoiceRepository, CommercialInvoiceMapper commercialInvoiceMapper, CommercialInvoiceSearchRepository commercialInvoiceSearchRepository) {
        super(commercialInvoiceRepository, commercialInvoiceMapper, commercialInvoiceSearchRepository);
