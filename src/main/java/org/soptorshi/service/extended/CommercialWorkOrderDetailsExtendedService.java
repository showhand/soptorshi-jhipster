...
@Service
@Transactional
public class CommercialWorkOrderDetailsExtendedService extends CommercialWorkOrderDetailsService {

    private final Logger log = LoggerFactory.getLogger(CommercialWorkOrderDetailsExtendedService.class);
    ...
    public CommercialWorkOrderDetailsExtendedService(CommercialWorkOrderDetailsRepository commercialWorkOrderDetailsRepository, CommercialWorkOrderDetailsMapper commercialWorkOrderDetailsMapper, CommercialWorkOrderDetailsSearchRepository commercialWorkOrderDetailsSearchRepository) {
        super(commercialWorkOrderDetailsRepository, commercialWorkOrderDetailsMapper, commercialWorkOrderDetailsSearchRepository);
