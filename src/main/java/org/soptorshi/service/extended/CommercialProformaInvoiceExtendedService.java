...
@Service
@Transactional
public class CommercialProformaInvoiceExtendedService extends CommercialProformaInvoiceService {

    private final Logger log = LoggerFactory.getLogger(CommercialProformaInvoiceExtendedService.class);
