...
@Service
@Transactional
public class SupplyChallanServiceImpl implements SupplyChallanService {

    private final Logger log = LoggerFactory.getLogger(SupplyChallanServiceImpl.class);
    ...
    public SupplyChallanServiceImpl(SupplyChallanRepository supplyChallanRepository, SupplyChallanMapper supplyChallanMapper, SupplyChallanSearchRepository supplyChallanSearchRepository) {
