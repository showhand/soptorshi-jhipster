...
public class SupplyAreaServiceImpl implements SupplyAreaService {
    ...
    private final Logger log = LoggerFactory.getLogger(SupplyAreaServiceImpl.class);
    ...
    public SupplyAreaServiceImpl(SupplyAreaRepository supplyAreaRepository, SupplyAreaMapper supplyAreaMapper, SupplyAreaSearchRepository supplyAreaSearchRepository) {
