...
@Service
@Transactional
public class SupplyAreaManagerServiceImpl implements SupplyAreaManagerService {

    private final Logger log = LoggerFactory.getLogger(SupplyAreaManagerServiceImpl.class);
    ...
    public SupplyAreaManagerServiceImpl(SupplyAreaManagerRepository supplyAreaManagerRepository, SupplyAreaManagerMapper supplyAreaManagerMapper, SupplyAreaManagerSearchRepository supplyAreaManagerSearchRepository) {
