...
@Service
@Transactional
public class SupplySalesRepresentativeServiceImpl implements SupplySalesRepresentativeService {

    private final Logger log = LoggerFactory.getLogger(SupplySalesRepresentativeServiceImpl.class);
    ...
    public SupplySalesRepresentativeServiceImpl(SupplySalesRepresentativeRepository supplySalesRepresentativeRepository, SupplySalesRepresentativeMapper supplySalesRepresentativeMapper, SupplySalesRepresentativeSearchRepository supplySalesRepresentativeSearchRepository) {
