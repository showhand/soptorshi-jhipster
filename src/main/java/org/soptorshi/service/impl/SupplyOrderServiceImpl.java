...
public class SupplyOrderServiceImpl implements SupplyOrderService {
    ...
    private final Logger log = LoggerFactory.getLogger(SupplyOrderServiceImpl.class);
    ...
    public SupplyOrderServiceImpl(SupplyOrderRepository supplyOrderRepository, SupplyOrderMapper supplyOrderMapper, SupplyOrderSearchRepository supplyOrderSearchRepository) {
