...
/**
 * Criteria class for the ItemSubCategory entity. This class is used in ItemSubCategoryResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /item-sub-categories?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ItemSubCategoryCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final ItemSubCategoryCriteria that = (ItemSubCategoryCriteria) o;
        return
    ...
    public String toString() {
        return "ItemSubCategoryCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
