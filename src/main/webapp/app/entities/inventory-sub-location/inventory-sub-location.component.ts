...
@Component({
    selector: 'jhi-inventory-sub-location',
    templateUrl: './inventory-sub-location.component.html'
})
export class InventorySubLocationComponent implements OnInit, OnDestroy {
