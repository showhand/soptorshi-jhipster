...
@Component({
    selector: 'jhi-commercial-purchase-order',
    templateUrl: './commercial-purchase-order.component.html'
})
export class CommercialPurchaseOrderComponent implements OnInit, OnDestroy {
