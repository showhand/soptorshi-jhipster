...
@Component({
    selector: 'jhi-commercial-purchase-order-item',
    templateUrl: './commercial-purchase-order-item.component.html'
})
export class CommercialPurchaseOrderItemComponent implements OnInit, OnDestroy {
