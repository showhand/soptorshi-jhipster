...
export class QuotationDetailsComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: IQuotationDetails) {
        return item.id;
    }
    ...
    registerChangeInQuotationDetails() {
        this.eventSubscriber = this.eventManager.subscribe('quotationDetailsListModification', response => this.loadAll());
    }
    ...
    protected paginateQuotationDetails(data: IQuotationDetails[], headers: HttpHeaders) {
