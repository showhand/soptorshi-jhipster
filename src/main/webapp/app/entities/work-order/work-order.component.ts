...
export class WorkOrderComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.workOrderService
                ...
                .subscribe(
                    (res: HttpResponse<IWorkOrder[]>) => this.paginateWorkOrders(res.body, res.headers),
    ...
    trackId(index: number, item: IWorkOrder) {
        return item.id;
    }
    ...
    protected paginateWorkOrders(data: IWorkOrder[], headers: HttpHeaders) {
