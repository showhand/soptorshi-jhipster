...
@Component({
    selector: 'jhi-supply-sales-representative',
    templateUrl: './supply-sales-representative.component.html'
})
export class SupplySalesRepresentativeComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ISupplySalesRepresentative) {
        return item.id;
    }

    registerChangeInSupplySalesRepresentatives() {
        this.eventSubscriber = this.eventManager.subscribe('supplySalesRepresentativeListModification', response => this.reset());
    }
