...
@Component({
    selector: 'jhi-commercial-payment-info',
    templateUrl: './commercial-payment-info.component.html'
})
export class CommercialPaymentInfoComponent implements OnInit, OnDestroy {
