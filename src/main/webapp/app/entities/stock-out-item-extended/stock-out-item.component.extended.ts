...
@Component({
    ...
    templateUrl: './stock-out-item.component.extended.html'
})
export class StockOutItemComponentExtended extends StockOutItemComponent implements OnInit, OnDestroy {
