...
@Component({
    ...
    templateUrl: './stock-out-item-update.component.extended.html'
})
export class StockOutItemUpdateComponentExtended extends StockOutItemUpdateComponent implements OnInit {
