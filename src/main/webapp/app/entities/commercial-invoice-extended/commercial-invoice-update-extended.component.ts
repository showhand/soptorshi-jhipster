...
import { CommercialInvoiceUpdateComponent } from 'app/entities/commercial-invoice';

@Component({
    selector: 'jhi-commercial-invoice-update-extended',
    templateUrl: './commercial-invoice-update-extended.component.html'
})
export class CommercialInvoiceUpdateExtendedComponent extends CommercialInvoiceUpdateComponent {
    ...
    constructor(
        ...
        super(
            ...
            commercialProformaInvoiceService,
            commercialPackagingService,
            activatedRoute
        );
    }
