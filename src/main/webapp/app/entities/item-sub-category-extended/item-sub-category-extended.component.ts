...
@Component({
    ...
    templateUrl: './item-sub-category-extended.component.html'
})
export class ItemSubCategoryExtendedComponent extends ItemSubCategoryComponent implements OnInit, OnDestroy {
