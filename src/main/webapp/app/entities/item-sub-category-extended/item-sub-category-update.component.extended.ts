...
@Component({
    ...
    templateUrl: './item-sub-category-update.component.extended.html'
})
export class ItemSubCategoryUpdateComponentExtended extends ItemSubCategoryUpdateComponent implements OnInit {
