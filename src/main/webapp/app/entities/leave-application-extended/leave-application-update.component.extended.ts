...
@Component({
    ...
    templateUrl: './leave-application-update.component.extended.html'
})
export class LeaveApplicationUpdateComponentExtended extends LeaveApplicationUpdateComponent implements OnInit {
