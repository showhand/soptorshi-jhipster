...
@Component({
    ...
    templateUrl: './stock-in-item-update.component.extended.html'
})
export class StockInItemUpdateComponentExtended extends StockInItemUpdateComponent implements OnInit {
