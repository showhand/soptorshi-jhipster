...
import { CommercialPackagingUpdateComponent } from 'app/entities/commercial-packaging';

@Component({
    selector: 'jhi-commercial-packaging-update-extended',
    templateUrl: './commercial-packaging-update-extended.component.html'
})
export class CommercialPackagingUpdateExtendedComponent extends CommercialPackagingUpdateComponent {
    ...
    constructor(
        ...
        super(jhiAlertService, commercialPackagingService, commercialPurchaseOrderService, activatedRoute);
    }
