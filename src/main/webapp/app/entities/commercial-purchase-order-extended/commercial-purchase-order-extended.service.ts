...
export class CommercialPurchaseOrderExtendedService extends CommercialPurchaseOrderService {
    public resourceUrl = SERVER_API_URL + 'api/extended/commercial-purchase-orders';
