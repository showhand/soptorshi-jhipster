...
@Component({
    ...
    templateUrl: './stock-in-process-update.component.extended.html'
})
export class StockInProcessUpdateComponentExtended extends StockInProcessUpdateComponent implements OnInit {
