...
@Component({
    ...
    templateUrl: './stock-in-process.component.extended.html'
})
export class StockInProcessComponentExtended extends StockInProcessComponent implements OnInit, OnDestroy {
