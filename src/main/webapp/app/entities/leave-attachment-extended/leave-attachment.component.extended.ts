...
@Component({
    ...
    templateUrl: './leave-attachment.component.extended.html'
})
export class LeaveAttachmentComponentExtended extends LeaveAttachmentComponent implements OnInit, OnDestroy {
