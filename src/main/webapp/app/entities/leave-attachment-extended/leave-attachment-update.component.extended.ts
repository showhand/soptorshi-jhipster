...
@Component({
    ...
    templateUrl: './leave-attachment-update.component.extended.html'
})
export class LeaveAttachmentUpdateComponentExtended extends LeaveAttachmentUpdateComponent implements OnInit {
