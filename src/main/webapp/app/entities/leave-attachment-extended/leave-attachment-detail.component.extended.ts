...
@Component({
    ...
    templateUrl: './leave-attachment-detail.component.extended.html'
})
export class LeaveAttachmentDetailComponentExtended extends LeaveAttachmentDetailComponent implements OnInit {
