...
export class TermsAndConditionsComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ITermsAndConditions) {
        return item.id;
    }
    ...
    registerChangeInTermsAndConditions() {
        this.eventSubscriber = this.eventManager.subscribe('termsAndConditionsListModification', response => this.loadAll());
    }
    ...
    protected paginateTermsAndConditions(data: ITermsAndConditions[], headers: HttpHeaders) {
