...
@Component({
    ...
    templateUrl: './holiday-type-detail.component.extended.html'
})
export class HolidayTypeDetailComponentExtended extends HolidayTypeDetailComponent implements OnInit {
