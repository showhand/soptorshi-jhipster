...
@Component({
    ...
    templateUrl: './dt-transaction.component.html'
})
export class DtTransactionComponent implements OnInit, OnDestroy {
    currentAccount: any;
    dtTransactions: IDtTransaction[];
    error: any;
    success: any;
    ...
    trackId(index: number, item: IDtTransaction) {
        return item.id;
    }

    registerChangeInDtTransactions() {
        this.eventSubscriber = this.eventManager.subscribe('dtTransactionListModification', response => this.loadAll());
    }
