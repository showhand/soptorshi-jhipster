...
@Component({
    selector: 'jhi-commercial-packaging-details',
    templateUrl: './commercial-packaging-details.component.html'
})
export class CommercialPackagingDetailsComponent implements OnInit, OnDestroy {
