...
@Component({
    selector: 'jhi-supply-area-manager',
    templateUrl: './supply-area-manager.component.html'
})
export class SupplyAreaManagerComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ISupplyAreaManager) {
        return item.id;
    }

    registerChangeInSupplyAreaManagers() {
        this.eventSubscriber = this.eventManager.subscribe('supplyAreaManagerListModification', response => this.reset());
    }
