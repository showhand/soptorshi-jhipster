...
@Component({
    selector: 'jhi-commercial-proforma-invoice',
    templateUrl: './commercial-proforma-invoice.component.html'
})
export class CommercialProformaInvoiceComponent implements OnInit, OnDestroy {
