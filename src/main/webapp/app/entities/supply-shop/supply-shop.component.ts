...
@Component({
    selector: 'jhi-supply-shop',
    templateUrl: './supply-shop.component.html'
})
export class SupplyShopComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ISupplyShop) {
        return item.id;
    }

    registerChangeInSupplyShops() {
        this.eventSubscriber = this.eventManager.subscribe('supplyShopListModification', response => this.reset());
    }
