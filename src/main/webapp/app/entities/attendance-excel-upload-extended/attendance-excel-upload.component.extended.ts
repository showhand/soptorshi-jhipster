...
@Component({
    ...
    templateUrl: './attendance-excel-upload.component.extended.html'
})
export class AttendanceExcelUploadComponentExtended extends AttendanceExcelUploadComponent implements OnInit, OnDestroy {
    ...
    constructor(
        protected attendanceExcelUploadServiceExtended: AttendanceExcelUploadServiceExtended,
    ...
    loadAll() {
        if (this.currentSearch) {
            this.attendanceExcelUploadServiceExtended
                .search({
