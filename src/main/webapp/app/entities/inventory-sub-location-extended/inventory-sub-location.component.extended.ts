...
@Component({
    ...
    templateUrl: './inventory-sub-location.component.extended.html'
})
export class InventorySubLocationComponentExtended extends InventorySubLocationComponent implements OnInit, OnDestroy {
