...
@Component({
    ...
    templateUrl: './inventory-sub-location-detail.component.extended.html'
})
export class InventorySubLocationDetailComponentExtended extends InventorySubLocationDetailComponent implements OnInit {
