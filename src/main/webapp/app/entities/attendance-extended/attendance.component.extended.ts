...
@Component({
    ...
    templateUrl: './attendance.component.extended.html'
})
export class AttendanceComponentExtended extends AttendanceComponent implements OnInit, OnDestroy {
    ...
    constructor(
        protected attendanceServiceExtended: AttendanceServiceExtended,
