...
@Component({
    ...
    templateUrl: './attendance-update.component.extended.html'
})
export class AttendanceUpdateComponentExtended implements OnInit {
    ...
    constructor(
        ...
        protected attendanceService: AttendanceServiceExtended,
